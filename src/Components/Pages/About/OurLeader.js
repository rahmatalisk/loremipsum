    ...
    return (
        <div className='bg-[#F7F7F7] py-[50px] md:py-[100px]'>
            ...
            <h3 className='font-[700] text-[16px] sm:text-[18px] md:text-[24px] text-[#FF3E54] leading-[20px] text-center'>\ Team \</h3>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-[30px] gap-y-[50px]'>
                    <div>
                        <img className='duration-300 hover:scale-95 max-h-[300px] block mx-auto' src="https://i.ibb.co/NsDGdvs/Rectangle-14.png" alt="" />
                    ...
                    <div>
                        <img className='duration-300 hover:scale-95 max-h-[300px] block mx-auto' src="https://i.ibb.co/2jJWvVm/Rectangle-15.png" alt="" />
                    ...
                    <div>
                        <img className='duration-300 hover:scale-95 max-h-[300px] block mx-auto' src="https://i.ibb.co/gTrDWKp/Rectangle-16.png" alt="" />
                    ...
                    <div>
                        <img className='duration-300 hover:scale-95 max-h-[300px] block mx-auto' src="https://i.ibb.co/1bQxTn8/Rectangle-17.png" alt="" />
